...
Rails.application.configure do
  ...
  # Skip http-to-https redirect for the health check endpoints (used by load balancers over plain HTTP).
  ...
  # Solid Queue runs in the primary database (single-database setup).
  ...
  # Set host to be used by links generated in mailer templates (magic links, etc).
