  ...
  private
    ...
    def product_params
      permitted = %i[name update_policy current_version max_activations_default trial_days
        ...
        affiliate_landing_url affiliate_transactional_id affiliate_commission_percent posthog_api_key]
      ...
      %i[loops_api_key posthog_api_key stripe_secret_key stripe_webhook_secret].each do |k|
